...
public class FamilyTree
{
	...
	public void addChild()
	{
		...
		if(node.child instanceof FamilyTreeNode == false)
		{
			node.child = create(childName);
			node.partner.child = node.child;
		}
		else if(!node.hasChild(childName))
		{
		...
		{
			System.out.println("ERROR: member already has child with name `" + childName + "`");
		}
	}
